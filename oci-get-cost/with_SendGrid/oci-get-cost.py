...
from modules.sendgrid_mod import go_sendgrid
...
# Sendgrid Mail Delivery settings
use_sendgrid = 'FALSE'
email_sender = "jack@megacorp.com" # must be the email_sender approved in SendGrid
email_recipients = [
    ('john.doe@corp.com', 'John Doe'),
	('john.lock@corp.com', 'John lock')
	]
...
SENDGRID_API_KEY='SG.hfFvDkrFOHXo3rAFL-xxxxxxxxxxxxxxxxxxxxxxxxx'
...
if use_sendgrid == 'TRUE':
	go_sendgrid(email_sender, email_recipients, subject, my_tenant, mail_txt, local_file, SENDGRID_API_KEY)
