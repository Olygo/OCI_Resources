...
profile = "ORACSMASSURANCE"					# specify your config file profile name and path
#configfile = '/home/opc/.oci/config'
configfile = '/home/opc/CloudAccounts/config/configASSURANCE'
...
cleanup = 'FALSE'							# If TRUE, the script will delete budget if no corresponding Tag found
...
# --- Budget parameters --- #
Type = "FORECAST"										# "ACTUAL": alert will trigger based on actual usage // "FORECAST": alert will trigger based on predicted usage
